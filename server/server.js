...
const MONGO_URI = process.env.MONGO_URI || 'mongodb://localhost:27017/apie_db';
...
app.get('/api/health', (req, res) => {
    res.json({ status: 'APIE Backend Running', version: '1.0.0', time: new Date().toISOString() });
});

app.listen(PORT, () => {
    console.log(`🚀 APIE Server running on http://localhost:${PORT}`);
});
